...
/// </summary>
/// <remarks>
/// <para>The converter lives in <c>ISEStudio.Application.Foundation</c>
/// rather than next to the source-gen context in
/// <c>ISEStudio.Serialization</c> because
...
/// ISEStudio (the dependency runs the other way). The source-gen
/// context in <c>ISEStudio/Serialization/ISEStudioJsonContext.cs</c>
