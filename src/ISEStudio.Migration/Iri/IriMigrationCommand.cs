...
/// <c>dotnet ISEStudio.Migration.dll iri &lt;subcommand&gt; ...</c>.</para>
/// </summary>
public static class IriMigrationCommand
{
    ...
    /// <summary>
    /// Default prefixes — match the .NET <c>ISEStudioOptions.IriRoot</c>
    ...
    /// <see cref="ISEStudioOptions.IriRoot"/> / <see cref="ISEStudioOptions.VocabNamespace"/>
    ...
    private static async Task<int> RunConfigAsync(IReadOnlyList<string> argv)
    {
        ...
        config.GetSection("ISEStudio").Bind(opts);
