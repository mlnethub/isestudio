...
/// <c>ISEStudioOptions.IriRoot</c> / <c>VocabNamespace</c> defaults.
///
...
/// To roll back, revert the .NET <c>ISEStudioOptions.IriRoot</c> /
...
public sealed class IriSqlMigrator
{
    ...
    /// <c>src/ISEStudio/Infrastructure/Persistence/Configurations/EntityConfigurations.cs</c>:
    ...
    public IriSqlMigrator(ISEStudioDbContext db, ILogger<IriSqlMigrator> logger)
    {
        _db = db;
        _logger = logger;
    }
