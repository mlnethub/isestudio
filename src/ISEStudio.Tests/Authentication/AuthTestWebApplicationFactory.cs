...
public class AuthTestWebApplicationFactory : WebApplicationFactory<Program>
{
    ...
    public const string SessionCookieName = "isestudio_session";
    ...
    /// <see cref="ISEStudioDbContext"/> against this factory's SQLite
