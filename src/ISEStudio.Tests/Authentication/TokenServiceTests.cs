...
public sealed class TokenServiceTests
{
    ...
    private static ISEStudioDbContext NewDb(out KnowledgeSystemEntity ks)
    {
    ...
    private static UserEntity NewUser(ISEStudioDbContext db, bool active = true)
    {
    ...
    private static KnowledgeApiTokenService NewService(ISEStudioDbContext db) =>
