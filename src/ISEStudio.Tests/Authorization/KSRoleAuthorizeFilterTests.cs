...
public sealed class KSRoleAuthorizeFilterTests
{
    ...
    private static async Task<UserEntity> SeedUserAsync(ISEStudioDbContext db, string name, bool isAdmin = false)
    {
    ...
    private static async Task<KnowledgeSystemEntity> SeedKnowledgeSystemAsync(
        ISEStudioDbContext db, UserEntity owner)
    {
    ...
    private static async Task SeedGrantAsync(ISEStudioDbContext db, Guid ksId, Guid userId, string role)
    {
    ...
    /// <summary>
    /// Owns an in-memory SQLite <see cref="ISEStudioDbContext"/> plus a
    ...
    private sealed class Harness : IAsyncDisposable
    {
        ...
        public Harness()
        {
            ...
            _services = new ServiceCollection()
                .AddSingleton<ISEStudioDbContext>(Db)
                .AddSingleton<KnowledgeSystemAccessService>()
                .BuildServiceProvider();
        }

        public ISEStudioDbContext Db { get; }
