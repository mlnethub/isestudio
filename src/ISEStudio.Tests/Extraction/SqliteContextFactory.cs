...
/// <see cref="ISEStudioDbContext"/> per operation rather than sharing the
...
/// </summary>
public sealed class SqliteContextFactory : IDbContextFactory<ISEStudioDbContext>, IDisposable
{
    ...
    public SqliteContextFactory()
    {
        ...
        // unrelated fixtures.
        var cacheName = $"isestudio-extraction-{Guid.NewGuid():N}";
