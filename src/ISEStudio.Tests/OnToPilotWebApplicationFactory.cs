...
namespace ISEStudio.Tests;

/// <summary>
/// Test host for the ISEStudio web project. Wraps the real ASP.NET Core
...
/// </remarks>
public sealed class ISEStudioWebApplicationFactory : WebApplicationFactory<Program>
{
    /// <inheritdoc />
