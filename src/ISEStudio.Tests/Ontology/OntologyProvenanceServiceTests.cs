...
public sealed class OntologyProvenanceServiceTests
{
    ...
    private static async Task<DocumentEntity> CreateDocumentAsync(ISEStudioDbContext db, Guid ksId, string name, string folder)
    {
    ...
    private static async Task<ChunkEntity> CreateChunkAsync(ISEStudioDbContext db, Guid docId)
    {
    ...
    private static void AddAxiom(ISEStudioDbContext db, Guid ksId, string key, Guid? chunkId, Guid? jobId = null)
    {
