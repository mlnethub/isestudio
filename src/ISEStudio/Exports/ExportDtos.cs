...
/// <c>_export_out()</c> shape exposes via <c>layer</c>. The wire values are
/// pinned lower-case; <see cref="Expand"/> turns a <c>bundle</c> layer into
/// the per-physical-layer list the runner iterates over.
/// </summary>
...
/// <summary>
/// Loose-body input to <c>POST /api/knowledge/{id}/exports</c>. Mirrors the
/// Python <c>ExportRequest</c> pydantic model
/// (<c>backend/app/api/releases.py</c>:716): <c>layer</c> is required,
/// <c>release_id</c> optional (MVP — release-bound exports raise
/// <see cref="ISEStudio.Api.ValidationException"/>), <c>shard_size</c>
/// optional (default 100_000, range 1_000 .. 5_000_000).
/// </summary>
