...
/// the EF <see cref="ISEStudioDbContext"/> flows through naturally.</para>
///
...
public sealed class TerminologyAgent
{
    ...
    /// the agent is Scoped so it reads <see cref="ISEStudioOptions"/>
    ...
    /// <summary>
    /// Internal so parity tests in <c>ISEStudio.Tests</c> can lock the
