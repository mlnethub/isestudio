...
///
/// <para>
/// Resolution rules — driven by <see cref="Configuration.ISEStudioOptions.SystemLanguage"/>:
/// <list type="bullet">
...
/// outstanding agents tracked in the dotnet-gap memory note from 2026-08-22.
/// </para>
/// </summary>
