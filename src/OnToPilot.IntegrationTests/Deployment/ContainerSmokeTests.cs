...
public sealed class ContainerSmokeTests : IClassFixture<ContainerSmokeFixture>
{
    ...
    /// <c>OnToPilot__LlmApiKey</c> canary value the fixture seeded. The
    /// secret redaction enricher (see
    /// <c>OnToPilot.Observability.SecretRedactionProcessor</c>) is the
    ...
    public void Startup_logs_do_not_leak_secrets()
    {
        ...
        Assert.DoesNotContain("ontopilot-smoke", logs, StringComparison.OrdinalIgnoreCase);
    }
