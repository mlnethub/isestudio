...
/// <see cref="OnToPilot.Observability.TelemetryExtensions.WithLlmActivity"/>
...
public sealed class TestActivityListener : IDisposable
{
    ...
    /// <see cref="OnToPilot.Observability.Telemetry"/> to capture only the
    /// OnToPilot-owned sources.
    /// </summary>
