...
/// <summary>
/// EF Core <see cref="DbContext"/> for OnToPilot's relational metadata store.
...
public sealed class OnToPilotDbContext : DbContext
{
    ...
    public OnToPilotDbContext(DbContextOptions<OnToPilotDbContext> options)
        : base(options)
    {
    }
