...
namespace OnToPilot.Observability;
...
/// <c>"OnToPilot.*"</c> wildcard) and to <see cref="MeterName"/> so a new
...
/// <c>OnToPilot.&lt;layer&gt;</c> activity, with the layer matching the
...
public static class Telemetry
{
    ...
    /// the OTel <c>"OnToPilot.*"</c> wildcard filter (which only works
    ...
    /// The OTel builder subscribes to <see cref="MeterName"/> ("OnToPilot")
    ...
    public static Counter<long> ExtractionsStarted { get; } =
        Meter.CreateCounter<long>(
            name: "ontopilot.extraction.started",
            unit: "{chunk}",
    ...
    public static Counter<long> ExtractionsCompleted { get; } =
        Meter.CreateCounter<long>(
            name: "ontopilot.extraction.completed",
            unit: "{chunk}",
    ...
    public static Histogram<double> ExtractionDuration { get; } =
        Meter.CreateHistogram<double>(
            name: "ontopilot.extraction.duration",
            unit: "ms",
