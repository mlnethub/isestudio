...
///     <see cref="OnToPilotOptions.SemanticCandidateThreshold"/>'s
...
/// so it shares the per-request <c>OnToPilotDbContext</c> lifetime with
...
public sealed class DuplicateJudge
{
    ...
    /// <see cref="OnToPilotOptions.EnableSemanticConflicts"/> is
    ...
    /// <see cref="OnToPilotOptions.VerifyDuplicatesWithLlm"/> is
