...
using OnToPilotOptionsConfig = OnToPilot.Configuration.OnToPilotOptions;
...
public sealed class RdfImportService
{
    ...
    private readonly OnToPilotOptionsConfig _options;
    ...
    public RdfImportService(StoreWrapper store)
    {
        ...
        _viewBuilder = null;
        _stats = null;
        _options = new OnToPilotOptionsConfig();
    }
    ...
    public RdfImportService(
        ...
        Microsoft.Extensions.Options.IOptions<OnToPilotOptionsConfig> options)
    {
        ArgumentNullException.ThrowIfNull(store);
