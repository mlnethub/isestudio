...
/// <see>OnToPilot.Integration.InternalOperationDispatcher</see> so the
...
/// (<c>OnToPilot:Llm:ModelChoices</c>, comma-separated); the C# service
/// pre-pends the active <see cref="OnToPilot.Configuration.OnToPilotOptions.ExtractModel"/>
...
public sealed class SettingsService
{
    ...
    private readonly OnToPilot.Configuration.OnToPilotOptions _options;
    ...
    /// </summary>
    public const string TemperatureConfigKey = "OnToPilot:Llm:Temperature";
    ...
    /// </summary>
    public const string ModelChoicesConfigKey = "OnToPilot:Llm:ModelChoices";

    public SettingsService(
        OnToPilotDbContext db,
        IConfiguration config,
        Microsoft.Extensions.Options.IOptions<OnToPilot.Configuration.OnToPilotOptions> options,
        TimeProvider clock)
    {
        _db = db;
        _config = config;
